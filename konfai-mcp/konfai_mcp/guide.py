...
TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "fine_tune_app": (
        ...
        "scratch); it is also the safer alternative to import_app + run_resume(weights_only=True), which needs the "
        "copied Config.yml to be edited by hand. It launches a tracked training job and writes a resolvable app "
    ...
    "plan_transform": (
        ...
        "that refused it named), SKIP (already written), REDUCE, REFUSED. That probe TOUCHES the output "
