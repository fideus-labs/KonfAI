...
from .config_io import validate_yaml_content as validate_yaml_content
from .config_io import write_config as write_config
from .config_io import yaml_dump_content as yaml_dump_content
from .file_io import basename_without_suffixes as basename_without_suffixes
from .file_io import full_suffix as full_suffix
from .file_io import read_dataset_sidecar as read_dataset_sidecar
from .file_io import read_text as read_text
from .file_io import read_text_range as read_text_range
from .file_io import read_text_tail as read_text_tail
...
def prediction_rules() -> dict[str, Any]:
    ...
    return {
        ...
        "authoring_checks": [
            ...
            "Uncertainty comes from TTA / MC-dropout configured in Prediction.yml, or a custom reduction.",
        ],
    }
