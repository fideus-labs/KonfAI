...
<ul class="kf-example-grid" aria-label="Deterministic transform examples on one real abdominal CT plane">
  ...
  <li><figure class="kf-example-card"><a class="kf-example-media" href="../_static/gallery/transforms/resample-shape.png" aria-label="Open the shape-resample output"><img src="../_static/gallery/transforms/resample-shape.png" alt="Resample output on a 220 by 220 grid." width="512" height="512" loading="lazy" decoding="async"></a><figcaption><strong>Resample to shape</strong><span>219 × 222 → 220 × 220 voxels</span><span class="kf-example-stats">OUTPUT GRID 220 × 220</span></figcaption></figure></li>
  <li><figure class="kf-example-card"><a class="kf-example-media" href="../_static/gallery/transforms/resample-spacing.png" aria-label="Open the spacing-resample output"><img src="../_static/gallery/transforms/resample-spacing.png" alt="Resample output showing the anisotropic target spacing." width="512" height="512" loading="lazy" decoding="async"></a><figcaption><strong>Resample spacing</strong><span>0.80 × 0.80 → 1.25 × 0.55 mm</span><span class="kf-example-stats">GEOMETRY-AWARE INTERPOLATION</span></figcaption></figure></li>
