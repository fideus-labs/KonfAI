 ...
 * @param {Function} run_patch
 * @returns {Promise<any>}
 */
export function infer_volume(volume, shape, channels, spacing, manifest_json, run_patch) {
    const ptr0 = passArrayF32ToWasm0(volume, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray32ToWasm0(shape, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArrayF64ToWasm0(spacing, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(manifest_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.infer_volume(ptr0, len0, ptr1, len1, channels, ptr2, len2, ptr3, len3, run_patch);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('konfai_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
